    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            ...
            <a class="navbar-brand brand-logo-mini" href=""><img
                    src="<%request.getServletPath();%>/assests/images/logo.png" alt="logo"/></a>
        </div>
                    ...
                    <div class="dropdown-menu navbar-dropdown navbar-dropdown-large preview-list"
                        ...
                        <a class="dropdown-item preview-item">
                            <div class="preview-thumbnail">
                                <img src="<%request.getServletPath();%>/assests/images/faces/face4.jpg"
                                        class="profile-pic">
                            </div>
                        ...
                        <a class="dropdown-item preview-item">
                            <div class="preview-thumbnail">
                                <img src="<%request.getServletPath();%>/assests/images/faces/face3.jpg"
                                        class="profile-pic">
                            </div>
                            <div class="preview-item-content">
                        ...
                        <a class="dropdown-item preview-item">
                            <div class="preview-thumbnail">
                                <img src="<%request.getServletPath();%>/assests/images/faces/face2.jpg"
                                        class="profile-pic">
                            </div>
                            <div class="preview-item-content">
